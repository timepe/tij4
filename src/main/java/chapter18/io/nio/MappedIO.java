    ...
    private static Tester[] tests = {
            new Tester("Stream Write") {
                ...
                public void test() throws IOException {
                    DataOutputStream dos = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(new File("temp.temp"))));
            ...
            new Tester("Mapped Read/Write") {
                @Override
                public void test() throws IOException {
                    /* 内存映射写入必须具有读写权限，所以要使用RandomAccessFile，不能使用FileOutputStream. */
